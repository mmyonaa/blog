...
section: "jeongcheogi"
tags: ["정보처리기사", "네트워크", "http", "상태코드"]
area: "NET"
topicId: "http-status-codes"
follows: "2026-08-05-ip-subnetting"
description: "HTTP 상태 코드는 응답 첫 줄의 세 자리 숫자로 요청 처리 결과를 알린다. 첫 자리로 갈리는 다섯 클래스와 2xx~5xx 대표 코드, 401 vs 403·301 vs 302·502 vs 503 vs 504처럼 헷갈리는 짝을 정보처리기사 시험 관점에서 정리한다."
---
