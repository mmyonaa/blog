...
section: "jeongcheogi"
tags: ["정보처리기사", "정보보안", "해시", "전자서명", "SHA-256"]
area: "SEC"
topicId: "hash-digital-signature"
follows: "2026-07-23-symmetric-asymmetric"
description: "해시 함수는 임의 길이 입력을 고정 길이 출력으로 압축하는 일방향 함수다. 이 성질이 왜 전자서명의 재료가 되는지, 개인키로 서명하고 공개키로 검증하는 절차와 그 절차가 인증·무결성·부인방지를 제공하는 이유를 정보처리기사 시험 관점에서 정리한다."
---
