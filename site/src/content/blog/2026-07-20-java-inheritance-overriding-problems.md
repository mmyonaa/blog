---
title: "정보처리기사 실기 Java 코딩 문제 — 상속과 오버라이딩 출력의 함정"
pubDate: 2026-07-20T07:05:14Z
section: "jeongcheogi"
tags: ["정보처리기사", "Java", "상속", "오버라이딩", "실기"]
area: "PRAC"
description: "정보처리기사 실기 Java 문제는 상속·오버라이딩·다형성으로 출력을 헷갈리게 만든다. 필드는 정적 바인딩, 메서드는 동적 바인딩이라는 한 가지 규칙과 super·생성자 호출 순서를 대표 코드로 추적한다."
---
