...
section: "jeongcheogi"
tags: ["정보처리기사", "운영체제", "데드락", "은행원알고리즘"]
area: "OS"
topicId: "deadlock-conditions"
description: "교착상태는 여러 프로세스가 서로의 자원을 기다리며 아무도 진행하지 못하는 상태다. 데드락이 성립하는 4가지 필요조건과 예방·회피·탐지·회복이라는 네 갈래 처리 방법을 정보처리기사 시험 관점에서 정리한다."
---
