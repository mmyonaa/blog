...
section: "jeongcheogi"
tags: ["정보처리기사", "정보보안", "CIA", "보안요소"]
area: "SEC"
topicId: "security-cia"
description: "정보보안의 기본 목표인 CIA 삼각형을 기밀성·무결성·가용성으로 나눠 정리하고, 위협 유형과 대응 기술, 확장 요소까지 정보처리기사 시험 관점에서 짚는다."
---

"보안이 잘 되어 있다"는 말은 너무 막연하다. 무엇이 지켜져야 잘 된 것인가? 정보보안은 이 질문에 세 가지 목표로 답한다. **기밀성, 무결성, 가용성**. 영문 머리글자를 따 **CIA 삼각형**이라 부른다.

정보처리기사에서는 "다음 상황에서 침해된 보안 요소는?" 형태로 자주 나온다. 세 요소를 각각 한 문장으로 구분할 수 있어야 한다.
